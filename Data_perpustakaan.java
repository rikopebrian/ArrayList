...
public class Data_perpustakaan {
    ...
    public static void main(String[] args) {
        ...
        dataMahasiswa.add(new Mahasiswa("1", "Riko Pebrian "));
        dataMahasiswa.add(new Mahasiswa("2", "Lee Min Ho"));
        dataMahasiswa.add(new Mahasiswa("3", "Song Joong Ki"));
        
         ArrayList <Buku> dataBuku = new ArrayList<>(); 

    dataBuku.add(new Buku("1", "Algoritma dan Struktur Data"));
    dataBuku.add(new Buku("2", "Dasar Pemrograman"));
    dataBuku.add(new Buku("3", "Bahasa Inggris"));
